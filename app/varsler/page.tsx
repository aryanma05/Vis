              ...
              <li key={n.id}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm">
                      <span className="font-medium text-white">{n.actor.name}</span>
                      <span className="text-mist"> kommenterte på </span>
                      <span className="font-medium text-white">{n.project?.title ?? "et prosjekt"}</span>
                    </p>
                  ...
                  {n.unread && <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-ice" aria-label="Ulest" />}
                </Link>
              </li>
            ))}
          </ul>
